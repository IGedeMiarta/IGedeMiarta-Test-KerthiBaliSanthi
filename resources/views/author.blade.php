    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between">
                <h4>Table Author</h4>
                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addModal">Add Author</button>
            </div>
            <hr>
                    ...
                    @forelse ($table as $a)
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('author.delete', $a->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-warning editBtn" data-name="{{ $a->name }}"
                                        data-url="{{ route('author.update', $a->id) }}" data-bs-toggle="modal"
